import 'package:app/widgets/stats.dart';
          ...
          children: [
            ...
            InkWell(
                ...
                child: activeVideoTrack != null && !activeVideoTrack!.muted
                    ...
                    : const Icon(Icons.videocam_off_sharp)),
          ...
          children: [
            ...
            if (firstAudioPublication != null && !isScreenShare)
              RemoteTrackPublicationMenuWidget(
                  pub: firstAudioPublication!, icon: Icons.volume_up),
            // Menu for RemoteTrackPublication<RemoteVideoTrack>
            if (videoPublication != null)
              RemoteTrackPublicationMenuWidget(
                pub: videoPublication!,
                icon: isScreenShare ? Icons.monitor : Icons.stream,
              ),
            if (videoPublication != null)
  ...
  Widget build(BuildContext context) => Material(
        ...
        child: PopupMenuButton<Function>(
          ...
          itemBuilder: (BuildContext context) => <PopupMenuEntry<Function>>[
            PopupMenuItem(
              child: const Text('60'),
              value: () => pub.setVideoFPS(60),
              onTap: () => pub.setVideoQuality(VideoQuality.HIGH),
            ),
            PopupMenuItem(
              child: const Text('30'),
